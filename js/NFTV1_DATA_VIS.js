...
function preload(){
	...
	data2 = loadTable('https://raw.githubusercontent.com/aubreyalfonzo/NFTVS/master/data/NFTV1/ART_TOTAL_NUM_SALES_20_21.csv', 'csv', 'header');
...
function draw() {
	...
	for(let i = 0; i<rc2; i++){
		...
		let num2 = data2.getNum(i, "Number of Sales (30-day)")/2500;
